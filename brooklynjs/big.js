window.onload = function() {
  ...
  function setSuperlink(href) {
    var superlinkElement = document.getElementById('superlink');
    if (href) {
      superlinkElement.href = href;
      superlinkElement.style.display = 'block';
    } else {
      superlinkElement.style.display = 'none';
    }
  }
  ...
  function go(n) {
    ...
    if (e.firstChild.nodeName === 'IMG') {
      ...
      var href = e.firstChild.getAttribute('superlink');
      setSuperlink(href);
      ...
      if (e.firstChild.className === 'white') {
      ...
      // document.body.style.backgroundColor = '#00FFB1' //e.style.backgroundColor;
      setSuperlink();
    }
